#' Setup config for the Tees Valley SLA splitter
#'
...
setup_TV_split <- function(bat_sp,plant_sp) {
  TV_split <- tibble::tribble(~SheetLabel,~FilterString,
                        ...
                        "Plants_Lowerplants_Protd_data",  paste0("SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='Yes' & stringr::str_detect(tolower(SLA_data$`Taxon group`),'",paste(unlist(plant_sp),collapse = '|'),"')"),
                        ...
                        "Bats_data", paste0("SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='Yes' & stringr::str_detect(SLA_data$`Latin Name`,'",paste(unlist(bat_sp),collapse = '|'),"')"),
                        ...
                        "Birds_DBAP_data", "SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP') & tolower(SLA_data$`Taxon group`)=='bird'",
                        "Fish_DBAP_data","SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP') & stringr::str_detect(tolower(SLA_data$`Taxon group`),'fish')",
                        "Insects_DBAP_data","SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP') & stringr::str_detect(tolower(SLA_data$`Taxon group`),'insect')",
                        "Mammals_DBAP_data","SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP') & tolower(SLA_data$`Taxon group`)=='terrestrial mammal'",
                        "Plants_DBAP_data",paste0("SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP') & stringr::str_detect(tolower(SLA_data$`Taxon group`),'",paste(unlist(plant_sp),collapse = '|'),"')"),
                        "WACA_sch9_data","SLA_data$`All UK Legally Protected (W&C Act, Badgers and Cons Regs) - Taxon Designated`=='No' & (stringr::str_detect(SLA_data$`North East LBAP - Short Names`,'Tees Valley BAP',negate=TRUE) | is.na(SLA_data$`North East LBAP - Short Names`)) & (SLA_data$`Wildlife & Countryside Act Sch 9 Part 1`=='Yes' | SLA_data$`Wildlife & Countryside Act Sch 9 Part 2`=='Yes')",
