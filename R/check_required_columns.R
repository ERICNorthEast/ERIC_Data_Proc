...
check_required_columns <- function(data_set,data_format) {
  ...
  switch (data_format,
    ...
    "bt" = return (all(c("Recorder","Common Name","Species Name", "Date", "Grid Reference", "Location Name", "Abundances","Comments", "Breeding status","Breeding details","Plumage") %in% colnames(data_set)))
