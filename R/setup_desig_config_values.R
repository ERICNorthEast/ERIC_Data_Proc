...
setup_desig_config_values <- function(){
  ...
  config_keys <- c("WACA1","WACA2","NO_DESIG","WAXCAPS","waxcap_sp","BIRD_AMBER","BIRD_RED","DURHAM_BAP","NLAND_BAP","TV_BAP","amber_sp","red_sp","red_from_amber_sp","amber_from_red_sp","durham_bap_sp","nland_bap_sp","tv_bap_sp")
